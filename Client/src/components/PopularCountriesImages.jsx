  ...
  return (
    <div>
        <div  style={{ backgroundImage: `url(${homebg})` }} className='bg-cover bg-center bg-no-repeat'>
            ...
            <Link to='/countries'>
                <Button outline size='lg' gradientDuoTone="pinkToOrange" pill className='mx-auto justify-items-center mt-12 hover:scale-105' style={{ zIndex: 1, marginBottom: '60px' }}>Browse more Countries <HiArrowCircleRight size={25} /></Button>
            </Link>
            ...
            <iframe
                width="100%"
                height="450"
                src="https://www.youtube.com/embed/pcvWft-dAp4"
