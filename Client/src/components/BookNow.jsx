...
function BookNow() {
  ...
  return (
<div>
  <div style={{ backgroundImage: `url(${homebg})` }} className="h-screen bg-cover bg-center bg-no-repeat pt-20 pb-10 flex justify-center items-center mt-20 md:mt-0"> {/* Add mt-20 for smaller devices to adjust for the fixed header */}
