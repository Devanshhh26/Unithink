...
function Categories() {
  return (
    <div>
        ...
        <div className='flex flex-wrap justify-center mt-10 mb-10 mx-auto text-center items-center lg:ml-24 ml-16' >
            <div className=' w-full md:w-1/2 lg:w-1/3 xl:w-1/4 '>
                <Card className=" bg-green-100 max-w-64 mb-4" >
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4">
                <Card className="max-w-64 bg-red-100 mb-4" >
            ...
            <div className=" w-full md:w-1/2 lg:w-1/3 xl:w-1/4">
                <Card className="max-w-64 bg-purple-100 mb-4">
                    <img src={category3} alt="" className='bg-purple-200 border rounded-full max-h-20' />
                    <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Skill Development
                    </h5>
                    <p className="font-normal text-gray-700 dark:text-gray-400">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Incidunt laboriosam quaerat voluptate qui provident aspernatur excepturi consequuntur nobis impedit blanditiis, nemo sequi eum molestiae doloremque, accusantium odit. Qui, harum ab?
                    </p>
                </Card>
            </div>
            <div className=" w-full md:w-1/2 lg:w-1/3 xl:w-1/4">
                <Card className="max-w-64 bg-yellow-100 mb-4" >
